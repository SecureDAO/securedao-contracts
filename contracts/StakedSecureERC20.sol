...
contract sSCR is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Secure", "sSCR", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSCR supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSCR
